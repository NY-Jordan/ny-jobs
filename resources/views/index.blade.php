    ...
    @if (!empty($jobs[0]))
        <section class="site-section">
            <div class="container">
                ...
                <div class="row mb-5 justify-content-center">
                    <div class="col-md-7 text-center">
                        <h2 class="section-title mb-2">Recents Jobs Offers</h2>
                    </div>
                </div>
        ...
        <div class="owl-carousel single-carousel">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 align-self-end text-center text-lg-right">
                        <img src="{{ asset('dist/images/person_transparent_2.png') }}" alt="Image"
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 align-self-end text-center text-lg-right">
                        <img src="{{ asset('dist/images/person_transparent.png') }}" alt="Image"
                            class="img-fluid mb-0">
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 ml-auto align-self-end">
                    <img src="{{ asset('dist/images/apps.png') }}" alt="Free Website Template by Free-Template.co"
                        class="img-fluid">
                </div>
            </div>
        </div>
