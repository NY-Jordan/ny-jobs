                            ...
                            <form method="POST" action="{{ route('updateProfil', auth()->user()->id) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="website"
                                        value="{{ auth()->user()->website }}" id="company-website" placeholder="https://">
                                </div>

                                <div class="form-group">
                                    <label for="company-website-fb">Facebook Username (Optional)</label>
                                    <input type="text" class="form-control" name="facebook"
                                        value="{{ auth()->user()->facebook }}" id="company-website-fb"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="twitter"
                                        value="{{ auth()->user()->twitter }}" id="company-website-tw"
                                        placeholder="@companyname">
                                </div>
                                <div class="form-group">
                                    <label for="company-website-tw">Linkedin Username (Optional)</label>
                                    <input type="text" class="form-control" name="linkedin"
                                        value="{{ auth()->user()->linkedin }}" id="company-website-tw"
                                        placeholder="companyname">
                                </div>
                                ...
                                <div class="row align-items-center mb-5">
                                    <div class="col-lg-4 ml-auto">
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <button type="submit"
                                                    class="btn btn-block btn-primary btn-md">Update</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
