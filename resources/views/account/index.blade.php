...
@section('content')
    <section class="section-hero overlay inner-page bg-image"
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <h1 class="text-white font-weight-bold">Accoun</h1>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-4 col-12">
                    <div class="border p-2 d-inline-block mr-3 rounded">
                        <img src="{{ asset(Storage::url(auth()->user()->logo)) }}" style="width: 100%;" alt="">
                    </div>
                    <div class="gradient-wrapper sidebar-item-box">
                        <ul class="nav tab-nav my-account-title">
                            <li class="nav-item">
                                <a class="active" href="#joboffers" aria-expanded="false" data-toggle="tab">Jobs Offers</a>
                ...
                <div class="col-lg-9 col-md-8 col-12">
                    <div class="tab-content my-account-wrapper gradient-wrapper input-layout1">
                        <div role="tabpanel" class="gradient-padding active tab-pane" id="joboffers">
                            <div class="row">
                                <div class="col-4">
                                    <h2 class="title-section">Jobs offers</h2>
                                </div>
                                <div class="col-8">
                            ...
                            <div>
                                <div class="div">
                                    <li class="job-listing d-block d-sm-flex pb-3 pb-sm-0 align-items-center" style="margin-bottom: 20px;border-bottom: 1px solid #eee;">
                                        <a href="">
                                    ...
                                    <li class="job-listing d-block d-sm-flex pb-3 align-items-center" style="margin-bottom: 20px ; border-bottom: 1px solid #eee; padding-bottom:5px;">
                                        <a href="">
                                            <a href="job-single.html"></a>
                                            {{-- <div class="job-listing-logo">
                                                <img src="{{ asset('dist/images/job_logo_1.jpg') }}"
